<template>
    <div class="Footer">
        <footer class="text-center py-4" style="margin-top: end;">
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-3">
                <div class="col">
                    <p class="text-muted my-2" style="font-family:abeezeeregular">What To Watch © 2022 Brand</p>
                </div>
                <div class="col">
                ...
                <div class="col">
                    <p class="text-muted my-2" style="font-family:abeezeeregular">Developed by: Jesrolcad &amp; Luctorgom</p>
                </div>
            </div>
        </div>
    </footer>
